<reject-to-party-docket-date-wise>
<loading-bar if={loading}></loading-bar>
<h4 class="no-print">Reject To Party  (Docket Date Wise)</h4>

<div show={reject_to_party_docket_date_wise =='reject_to_party_docket_date_wise_home'} class="no-print">
...
<div  class="container-fluid print-box" show={reject_to_party_docket_date_wise =='reject_to_party_docket_date_wise_report'}>
...
<center>
  ...
  <div>Reject To Party  (Docket Date Wise)<br> From {issueFrom} To {issueTo}</div> <br>
</center>
    ...
    <div each={d, j in m.issues}>
        <table class="table print-small">
           <tr>
             ...
             <td>Docket Date: <b>{d.rejectDetails.docket_date}</b></td>
