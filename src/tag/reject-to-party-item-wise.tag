<reject-to-party-item-wise>
<loading-bar if={loading}></loading-bar>
<h4 class="no-print">Reject To Party (Item Wise)</h4>

<div show={reject_to_party_item_wise =='reject_to_party_item_wise_home'} class="no-print">
...
<div  class="container-fluid print-box" show={reject_to_party_item_wise =='reject_to_party_item_wise_report'}>
...
<center>
  ...
  <div>Reject To Party (Item Wise)<br> From {issueFrom} To {issueTo}</div> <br>
</center>
