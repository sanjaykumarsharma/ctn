<return-to-stock-dept-wise>
<loading-bar if={loading}></loading-bar>
<h4 class="no-print">Return To Stock (Department Wise)</h4>

<div show={return_to_stock_dept_wise =='return_to_stock_dept_wise_home'} class="no-print">
...
<div  class="container-fluid print-box" show={return_to_stock_dept_wise =='return_to_stock_dept_wise_report'}>
...
<center>
  ...
  <div>Return To Stock (Department Wise)<br> From {issueFrom} To {issueTo}</div> <br>
</center>
