...
$app->delete('/invoice/:order_id/:despatch_id', 'deletePrintList');
//*******************Invoice Detail*************
...
function deletePrintList($order_id,$despatch_id){
   $dm = new ContactService();
   $delete = $dm->deletePrintList($order_id,$despatch_id);
   echo json_encode($delete);
}
